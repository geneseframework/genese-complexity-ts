...
var CymsMock = /** @class */ (function () {
    ...
    CymsMock.prototype.set = function (object, path, value) {
        ...
        path.slice(0, -1).reduce(function (acc, curr, index) { return _this.reducer(acc, curr, index, +path); }, object)[path[path.length - 1]] = value; // Finally assign the value to the last key
