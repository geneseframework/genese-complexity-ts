...
var TsFolderService = /** @class */ (function (_super) {
    ...
    TsFolderService.generateTree = function (path, extension, folder) {
        ...
        // console.log('PATHHH FOLDER TO ANALYSE Options.pathFolderToAnalyse', Options.pathFolderToAnalyse);
        tsFolder.relativePath = file_service_1.getRelativePath(options_1.Options.pathFolderToAnalyse, path);
    ...
    TsFolderService.prototype.getSubject = function () {
        this._stats.subject = file_service_1.getRelativePath(options_1.Options.pathRoot, this.tsFolder.path);
    };
